...
and After Earth (2013). Jaden is also known for some of his philosophy that he delivers via Twitter.
 ...
 in the example below. Your task is to convert strings to how they would be written by Jaden Smith.
...
String.prototype.toJadenCase = function () {
    ...
    let jadenSmithArray = newArray.map((eachWord) => eachWord[0].toUpperCase() + eachWord.slice(1));
    let upperizedString = jadenSmithArray.join(" ");
